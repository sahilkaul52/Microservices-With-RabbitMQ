...
@Tag(
        ...
        description = "CRUD REST APIs in Bank to GET customer details"
)
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
                                                                   ...
                                                                   String mobileNumber)
    {
        logger.debug("fetchCustomerDetails method start"); //yahan par pehle we added a logger with correlationId generated in apigw
